...
- [OpenCode CLI](https://opencode.ai/docs/) installed and authenticated
...
Or via Homebrew, npm, or other package managers. See [OpenCode installation docs](https://opencode.ai/docs/) for details.
...
See [OpenCode configuration docs](https://opencode.ai/docs/) for details.
